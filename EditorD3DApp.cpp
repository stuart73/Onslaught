...
// Desc:
//-----------------------------------------------------------------------------
HRESULT CEditorD3DApp::Resize3DEnvironment()
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT CEditorD3DApp::ToggleFullscreen()
{
...
//       and/or adapter
//-----------------------------------------------------------------------------
HRESULT CEditorD3DApp::ForceWindowed()
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT CEditorD3DApp::AdjustWindowForChange()
{
    if( m_bWindowed )
    {
...
//-----------------------------------------------------------------------------
HRESULT CEditorD3DApp::UserSelectNewDevice()
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
INT_PTR CALLBACK CEditorD3DApp::SelectDeviceProc( HWND hDlg, UINT msg,
...
HRESULT CEditorD3DApp::Render3DEnvironment()
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
VOID CEditorD3DApp::Pause( BOOL bPause )
{
...
//-----------------------------------------------------------------------------
VOID CEditorD3DApp::Cleanup3DEnvironment()
{
    m_bActive = FALSE;
    m_bReady  = FALSE;
...
//-----------------------------------------------------------------------------
HRESULT CEditorD3DApp::DisplayErrorMsg( HRESULT hr, DWORD dwType )
{
    TCHAR strMsg[512];
